...
> [!NOTE] 核心觀點
> 2026 年 AI 基建的主要瓶頸已不再只是算力，而是逐步轉向 **記憶體、儲存、電力與冷卻** 等更底層的資源約束。其中，記憶體與儲存的供需失衡被多份產業資料描述為 **2027–2028 前仍可能持續的多年份壓力**，而電網與冷卻則是 AI 機房擴張的現實限制。
...
|:---|:---:|:---:|:---|:---|:---|
| 🔴 **Memory** | 高 | 2027–2028 前後 | Micron (MU)、SanDisk (SNDK)、SK hynix (000660.KS)、Samsung (005930.KS) | MU = 核心倉；SNDK = 高 beta 衛星倉 | HBM/DRAM/NAND 直接受惠 AI 記憶體瓶頸 |
...
> [!TIP] 配置邏輯
> 三種角色並存，能同時保留產業 Beta 與題材 Alpha，也比較符合 2–3 年視角的主題投資節奏。
